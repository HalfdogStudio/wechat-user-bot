!function () {
  ...
  for (var r = window.console = window.console || {
  }; n--; ) e = o[n],
  r[e] || (r[e] = t)
}(),
    ...
    function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p, h, M, y, C, v, w) {
      ...
      function T() {
        ...
        s.init().then(function (n) {
          ...
          var r = n.ClickReportInterval || 300000;
      ...
      function E() {
        t.debug && (F && o.cancel(F), C.start(40000), F = o(function () {
      ...
      angular.module('Controllers').controller('contentChatController', [
        ...
        function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p, h, M, y) {
          function C(o) {
            ...
            if (e.currentUser = o, e.chatContent = i.getChatMessage(o, !0), e.imagesMessagesList = [
            ], e.messagesAnimate = !1, t(function () {
              e.messagesAnimate = !0
            }, 200), n) {
              ...
              controller: [
                ...
                function (e) {
                  ...
                  e.save = function (t) {
                    ...
                    39,
                    46,
                    13].indexOf(t.keyCode) && r > 13 ? void t.preventDefault()  : void (t && 13 != t.keyCode || (n.length > 17 && (n = n.substring(0, 18)), e.editing = !1, e.contact.RemarkName = n, M({
                      method: 'POST',
          ...
          }; var E = !1; e.$on('mmRepeat:change', function () {
            E && (S.scrollTop = 99999)
          }); var N, P = !0; e.$watchCollection('chatContent', function (e) {
          ...
          function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m) {
            ...
            function v(e, t) {
              ...
              if (t || M(), window.getSelection) {
                !t && A ? (o = P, n = A)  : (o = window.getSelection(), n = o.getRangeAt(0)),
                n.deleteContents();
                var r;
              ...
              require.async(['webuploader'], function (e) {
                ...
                try {
                  Y = e.create({
                    ...
                    if (T(e.ext)) {
                      if (e.size > 1024 * B * 1024) return alert(MM.context('8c88ff6') + B + 'M'),
                      !1
                    } else if (e.size > 1024 * H * 1024) return alert(MM.context('0c9c48a') + H + 'M'),
                    !1;
            ...
            var P,
            A,
            I = document.getElementById('caretPosHelper'),
            k = 0,
            F = 0,
              ...
              if (o == a.KEYCODE_ENTER) {
                if (e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) {
                  ...
                  if (!u.browser.msie && window.getSelection) {
                    ...
                    do if (!r || r.nodeValue || 'BR' == r.tagName) break;
          ...
          angular.module('Controllers').controller('createChatroomController', [
            ...
            function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p) {
              o(function () {
                ...
                t.allContacts = c.pickContacts(['star',
                'friend'], {
                  star: {
                    filterContacts: h
                  },
          ...
          angular.module('Controllers').controller('contextMenuController', [
            ...
            function (e, t, o, n, r, a, i, c, s, l, u, f) {
              function d(e) {
                ...
                for (var n = [
                  e.target
                ], r = e.path || e.originalEvent.path || o(e.target), a = 0, i = r.length; i > a; a++) {
                      ...
                      controller: [
                        ...
                        function (e) {
                          e.keypress = function (e) {
                            ...
                            37,
                            39,
                            46].indexOf(e.keyCode) && t > 17 && e.preventDefault()
                          },
                  ...
                  var s = {
                    ...
                    sync: function () {
                      ...
                      return c({
                        ...
                        url: o.API_webwxsync + '?' + ['sid=' + n.getSid(),
                        'skey=' + n.getSkey()].join('&'),
                    ...
                    syncCheck: function () {
                      var e = t.defer(),
                      c = this,
                      s = o.API_synccheck + '?' + ['r=' + a.now(),
                      'skey=' + encodeURIComponent(n.getSkey()),
                      'sid=' + encodeURIComponent(n.getSid()),
                      'uin=' + n.getUin(),
                      'deviceid=' + n.getDeviceID(),
                      'synckey=' + encodeURIComponent(n.getFormateSyncKey())].join('&');
                ...
                function ($rootScope, $timeout, $http, $q, contactFactory, accountFactory, emojiFactory, confFactory, notificationFactory, utilFactory, reportService, mmHttp, titleRemind) {
                  ...
                  service = {
                    ...
                    createMessage: function (e) {
                      switch (e.FromUserName || (e.FromUserName = accountFactory.getUserName()), e.ToUserName || (e.ToUserName = this.getCurrentUserName()), e.ClientMsgId = e.LocalID = e.MsgId = (utilFactory.now() + Math.random().toFixed(3)).replace('.', ''), e.CreateTime = Math.round(utilFactory.now() / 1000), e.MMStatus = confFactory.MSG_SEND_STATUS_READY, e.MsgType) {
                    ...
                    _commonMsgProcess: function (e) {
                      ...
                      utilFactory.isRoomContact(e.MMPeerUserName) ? (e.MMIsChatRoom = !0, r = e.Content.replace(/^(@[a-zA-Z0-9]+|[a-zA-Z0-9_-]+):<br\/>/, function (e, t) {
                        return a = t,
                        ''
                    ...
                    _appReaderMsgProcess: function (e, t) {
                      ...
                      e.MMCategory = 1 == t.category.count ? [
                        t.category.item
                      ] : t.category.item,
                      angular.forEach(e.MMCategory, function (e) {
                        var t = new Date(1000 * e.pub_time);
                    ...
                    _appRealtimeShareLocationMsgProcess: function (e) {
                      ...
                      if (e.FromUserName == accountFactory.getUserName()) t = '[' + MM.context('8e94ca5') + ']';
                        ...
                        var o,
                        n = contactFactory.getContact(e.MMActualSender);
                    ...
                    _systemMsgProcess: function (e) {
                      ...
                      if (t) for (var o, n, r = 0, a = t.length; a > r; ++r) o = /&lt;a href=(?:'|")(.*?)(?:'|").*?&gt;.*?&lt;\/a&gt;/.exec(t[r]),
                    ...
                    _calcMsgDisplayTime: function (e, t) {
                      if (t && !(t.MsgType < 0)) if (!e || e.MsgType < 0) {
                        var o = new Date(1000 * t.CreateTime);
                  ...
                  function (e, t, o) {
                    ...
                    f = {
                      ...
                      getFormateSyncKey: function () {
                        for (var e = this.getSyncKey().List, t = [
                        ], o = 0, n = e.length; n > o; o++) t.push(e[o].Key + '_' + e[o].Val);
                        return t.join('|')
                      },
                    ...
                    A = {
                      ...
                      addBatchgetContact: function (e, t, r) {
                        ...
                        function s(e) {
                          ...
                          E++,
                          f.reject(e),
                          1 == t.length ? (console.log('batchGetContactError', t[0]), b[t[0].UserName] = 1)  : angular.forEach(t, function (e) {
                      ...
                      remoteSearch: function (e) {
                        function n(e) {
                          for (var t, o, n = [
                          ], r = 0; r < e.length; r++) t = e[r].EncryUserName,
                          o = g[t],
                  ...
                  function (e, t, o) {
                    ...
                    var u = {
                      ...
                      hrefEncode: function (e) {
                        ...
                        if (o) {
                          for (var n, r, a = 0, c = o.length; c > a; ++a) n = /&lt;a href=(?:'|")(.*?)(?:'|").*?&gt;.*?&lt;\/a&gt;/.exec(o[a]),
                      ...
                      evalVal: function (e) {
                        var t,
                        o = 'a' + this.now();
                        return this.globalEval(['(function(){try{window.',
                        o,
                        '=',
                        e,
                        ';}catch(_oError){}})();'].join('')),
              ...
              !function () {
                ...
                !function () {
                  ...
                  angular.module('Services').factory('resourceService', [
                    ...
                    function (e, t, o, n) {
                      function r(t, o, n) {
                        if (t instanceof Array || (t = [
                          t
                        ]), !(t.length > 0)) return void e(n, 0);
                        o = o || {
                        };
                    ...
                    function (e, t, o, n) {
                      ...
                      function f() {
                        for (var e = [
                          ...
                          15000,
                          600000
                        ], o = 0; o < e.length; o++) setTimeout(function (e) {
                          return function () {
                            w[e] = m(t)
                          }
                        }(e[o]), e[o])
                ...
                !function () {
                  'use strict';
                  angular.module('Services').factory('surviveCheckService', [
                    '$http',
                    '$q',
                    '$timeout',
                    function () {
                ...
                !function () {
                  'use strict';
                  angular.module('Services').factory('titleRemind', [
                    '$window',
                    function (e) {
                      function t(e, t) {
                        function o() {
                ...
                !function () {
                  'use strict';
                  angular.module('Services').factory('subscribeMsgService', [
                    '$rootScope',
                    'contactFactory',
                    'accountFactory',
                    'confFactory',
                ...
                angular.module('Directives').directive('previewDirective', [
                        ...
                        function (u, f, d, g, m, p, h, M, y) {
                          ...
                          v = {
                            open: function (a) {
                              ...
                              var b,
                              T,
                              E = e.isObject(w.scope) ? w.scope.$new()  : p.$new();
                  ...
                  angular.module('Directives').directive('mmRepeat', [
                    ...
                    function (e, t) {
                      ...
                      function a(e, t, o, n) {
                        var a,
                        i = r(n, t, e.bufferHeight, e.heightCalc);
                      ...
                      function i(e) {
                        if (!(e.length <= 0)) for (var t, o = 0, n = 0; n < e.length; n++) t = e[n],
                        t._offsetTop = o,
                        o += t._h
                      }
                      function c(e, t, o) {
                      ...
                      function s(e, t, o) {
                        ...
                        for (var r, a = e.length, i = 0, c = 0; a > c; c++) r = e[c],
                        r._h ? (i++, i == a && n(e))  : (console.log('pre', 'callcalc'), t(r, function (t) {
                          return function (o) {
                            t._h = o,
                            t._calcing = !1,
                            i++,
                      ...
                      function (e, t, o, n, r, a, i, c, s, l, u, f) {
                          ...
                          return {
                            ...
                            link: function (c) {
                              ...
                              function u() {
                                ...
                                c.allContacts = n.pickContacts(['star',
                                'chatroom',
                                'friend'], {
                                  friend: {
                                    isWithoutStar: !0,
                          ...
                          function (e, t) {
                            return {
                              ...
                              link: function (e, o, n) {
                                ...
                                u = 'src',
                                f = n.src,
                                d = n.mmSrcTimeout ? parseInt(n.mmSrcTimeout)  : 5000,
                        ...
                        angular.module('Directives').directive('contactPicker', [
                          ...
                          function (e, t, o, n, r, a, i, c, s, l, u, f) {
                            ...
                            'use strict';
                            angular.module('Filters').filter('emojiFilter', [
                              'emojiFactory',
                              function (e) {
                                return function (t) {
                              ...
                              function (e) {
                                return {
                                  request: function (t) {
                                    ...
                                    }), t.params.pass_ticket = e.getPassticket()), t.url.indexOf('.html') < 0) {
