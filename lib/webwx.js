...
function checkLogin(wxSession) {
  ...
  return new Promise((resolve, reject)=> {
    var checkUrl = `https://login.weixin.qq.com/cgi-bin/mmwebwx-bin/login?loginicon=true&tip=${wxSession.tip}&uuid=${uuid}&r=${timestamp}` 
    info('GET ' + checkUrl)
    request(checkUrl,
...
function webwxgetmedia(o, wxSession, filePath){
  ...
  return new Promise((resolve, reject)=>{
    var fileUrl = `https://file.wx.qq.com/cgi-bin/mmwebwx-bin/webwxgetmedia`;
    var params = {
